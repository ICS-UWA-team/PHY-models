...
plot_sign = ["DFE_RLS_1"; "DFE_RLS_2"; "DFE_RLS_3"; "DFE_RLS_4"; "DFE_RLS_5"; "DFE_RLS_6"; "DFE_RLS_7"; "DFE_RLS_8"; "DFE_RLS_9"; "DFE_RLS_10"];
num_eq = length(plot_sign);
eq_DFE_RLS_1 = comm.DecisionFeedbackEqualizer('Algorithm', 'RLS', 'NumForwardTaps', 1, 'NumFeedbackTaps', 1, 'ForgettingFactor', 0.99, 'ReferenceTap', 1);
eq_DFE_RLS_2 = comm.DecisionFeedbackEqualizer('Algorithm', 'RLS', 'NumForwardTaps', 2, 'NumFeedbackTaps', 2, 'ForgettingFactor', 0.99, 'ReferenceTap', 1);
eq_DFE_RLS_3 = comm.DecisionFeedbackEqualizer('Algorithm', 'RLS', 'NumForwardTaps', 3, 'NumFeedbackTaps', 3, 'ForgettingFactor', 0.99, 'ReferenceTap', 1);
eq_DFE_RLS_4 = comm.DecisionFeedbackEqualizer('Algorithm', 'RLS', 'NumForwardTaps', 4, 'NumFeedbackTaps', 4, 'ForgettingFactor', 0.99, 'ReferenceTap', 1);
eq_DFE_RLS_5 = comm.DecisionFeedbackEqualizer('Algorithm', 'RLS', 'NumForwardTaps', 5, 'NumFeedbackTaps', 5, 'ForgettingFactor', 0.99, 'ReferenceTap', 1);
eq_DFE_RLS_6 = comm.DecisionFeedbackEqualizer('Algorithm', 'RLS', 'NumForwardTaps', 6, 'NumFeedbackTaps', 6, 'ForgettingFactor', 0.99, 'ReferenceTap', 1);
eq_DFE_RLS_7 = comm.DecisionFeedbackEqualizer('Algorithm', 'RLS', 'NumForwardTaps', 7, 'NumFeedbackTaps', 7, 'ForgettingFactor', 0.99, 'ReferenceTap', 1);
eq_DFE_RLS_8 = comm.DecisionFeedbackEqualizer('Algorithm', 'RLS', 'NumForwardTaps', 8, 'NumFeedbackTaps', 8, 'ForgettingFactor', 0.99, 'ReferenceTap', 1);
eq_DFE_RLS_9 = comm.DecisionFeedbackEqualizer('Algorithm', 'RLS', 'NumForwardTaps', 9, 'NumFeedbackTaps', 9, 'ForgettingFactor', 0.99, 'ReferenceTap', 1);
eq_DFE_RLS_10 = comm.DecisionFeedbackEqualizer('Algorithm', 'RLS', 'NumForwardTaps', 10, 'NumFeedbackTaps', 10, 'ForgettingFactor', 0.99, 'ReferenceTap', 1);
eq_array = {eq_DFE_RLS_1; eq_DFE_RLS_2; eq_DFE_RLS_3; eq_DFE_RLS_4; eq_DFE_RLS_5; eq_DFE_RLS_6; eq_DFE_RLS_7; eq_DFE_RLS_8; eq_DFE_RLS_9; eq_DFE_RLS_10};
