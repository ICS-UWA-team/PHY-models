...
eq_DFE_LMS_1 = comm.DecisionFeedbackEqualizer('Algorithm', 'LMS', 'NumForwardTaps', 1, 'NumFeedbackTaps', 1, 'ForgettingFactor', 0.9, 'ReferenceTap', 1);
eq_DFE_LMS_2 = comm.DecisionFeedbackEqualizer('Algorithm', 'LMS', 'NumForwardTaps', 2, 'NumFeedbackTaps', 2, 'ForgettingFactor', 0.9, 'ReferenceTap', 1);
eq_DFE_LMS_3 = comm.DecisionFeedbackEqualizer('Algorithm', 'LMS', 'NumForwardTaps', 3, 'NumFeedbackTaps', 3, 'ForgettingFactor', 0.9, 'ReferenceTap', 1);
eq_DFE_LMS_4 = comm.DecisionFeedbackEqualizer('Algorithm', 'LMS', 'NumForwardTaps', 4, 'NumFeedbackTaps', 4, 'ForgettingFactor', 0.9, 'ReferenceTap', 1);
eq_DFE_LMS_5 = comm.DecisionFeedbackEqualizer('Algorithm', 'LMS', 'NumForwardTaps', 5, 'NumFeedbackTaps', 5, 'ForgettingFactor', 0.9, 'ReferenceTap', 1);
eq_DFE_LMS_6 = comm.DecisionFeedbackEqualizer('Algorithm', 'LMS', 'NumForwardTaps', 6, 'NumFeedbackTaps', 6, 'ForgettingFactor', 0.9, 'ReferenceTap', 1);
eq_DFE_LMS_7 = comm.DecisionFeedbackEqualizer('Algorithm', 'LMS', 'NumForwardTaps', 7, 'NumFeedbackTaps', 7, 'ForgettingFactor', 0.9, 'ReferenceTap', 1);
eq_DFE_LMS_8 = comm.DecisionFeedbackEqualizer('Algorithm', 'LMS', 'NumForwardTaps', 8, 'NumFeedbackTaps', 8, 'ForgettingFactor', 0.9, 'ReferenceTap', 1);
eq_DFE_LMS_9 = comm.DecisionFeedbackEqualizer('Algorithm', 'LMS', 'NumForwardTaps', 9, 'NumFeedbackTaps', 9, 'ForgettingFactor', 0.9, 'ReferenceTap', 1);
eq_DFE_LMS_10 = comm.DecisionFeedbackEqualizer('Algorithm', 'LMS', 'NumForwardTaps', 10, 'NumFeedbackTaps', 10, 'ForgettingFactor', 0.9, 'ReferenceTap', 1);
