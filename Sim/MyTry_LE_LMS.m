...
% eq_LE_LMS_1 = comm.LinearEqualizer('Algorithm', 'LMS', 'NumTaps', 1, 'StepSize', 0.03, 'ReferenceTap', 1);
% eq_LE_LMS_2 = comm.LinearEqualizer('Algorithm', 'LMS', 'NumTaps', 2, 'StepSize', 0.03, 'ReferenceTap', 1);
% eq_LE_LMS_3 = comm.LinearEqualizer('Algorithm', 'LMS', 'NumTaps', 3, 'StepSize', 0.03, 'ReferenceTap', 1);
% eq_LE_LMS_4 = comm.LinearEqualizer('Algorithm', 'LMS', 'NumTaps', 4, 'StepSize', 0.03, 'ReferenceTap', 1);
% eq_LE_LMS_5 = comm.LinearEqualizer('Algorithm', 'LMS', 'NumTaps', 5, 'StepSize', 0.03, 'ReferenceTap', 1);
% eq_LE_LMS_6 = comm.LinearEqualizer('Algorithm', 'LMS', 'NumTaps', 6, 'StepSize', 0.03, 'ReferenceTap', 1);
% eq_LE_LMS_7 = comm.LinearEqualizer('Algorithm', 'LMS', 'NumTaps', 7, 'StepSize', 0.03, 'ReferenceTap', 1);
% eq_LE_LMS_8 = comm.LinearEqualizer('Algorithm', 'LMS', 'NumTaps', 8, 'StepSize', 0.03, 'ReferenceTap', 1);
% eq_LE_LMS_9 = comm.LinearEqualizer('Algorithm', 'LMS', 'NumTaps', 9, 'StepSize', 0.03, 'ReferenceTap', 1);
% eq_LE_LMS_10 = comm.LinearEqualizer('Algorithm', 'LMS', 'NumTaps', 10, 'StepSize', 0.03, 'ReferenceTap', 1);
eq_LE_LMS_1 = comm.LinearEqualizer('Algorithm', 'LMS', 'NumTaps', 1, 'StepSize', 0.03, 'ReferenceTap', 1);
eq_LE_LMS_2 = comm.LinearEqualizer('Algorithm', 'LMS', 'NumTaps', 2, 'StepSize', 0.03, 'ReferenceTap', 1);
eq_LE_LMS_3 = comm.LinearEqualizer('Algorithm', 'LMS', 'NumTaps', 3, 'StepSize', 0.03, 'ReferenceTap', 1);
eq_LE_LMS_4 = comm.LinearEqualizer('Algorithm', 'LMS', 'NumTaps', 4, 'StepSize', 0.03, 'ReferenceTap', 1);
