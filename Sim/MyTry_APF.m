...
memory_Y = {};
memory_Y_eq = {};
Simulation_MonteCarloRepetitions = 1;                                  
...
eq_APF_4 = dsp.AffineProjectionFilter(4);
eq_APF_5 = dsp.AffineProjectionFilter(5);
eq_APF_6 = dsp.AffineProjectionFilter(6);
eq_APF_7 = dsp.AffineProjectionFilter(7);
eq_APF_8 = dsp.AffineProjectionFilter(8);
