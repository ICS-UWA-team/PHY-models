...
#include "myModel_withoutRxTx.h"       /* Model's header file */
#include "rtwtypes.h"
...
int_T main(int_T argc, const char *argv[])
{
  ...
  /* Initialize model */
  myModel_withoutRxTx_initialize();

  /* Attach rt_OneStep to a timer or interrupt service routine with
   * period 1.6666666666666667E-6 seconds (the model's base sample time) here.  The
